<table class="table table-bordered table-striped table-hover ajaxTable datatable data-table" id="supplyChainCustomers-table">
    <thead>
        <tr>
    ...
    <script>
        $(function () {
            let table = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('supplyChainCustomers.index')}}",
                columns: [
