<table class="table table-bordered table-striped table-hover ajaxTable datatable data-table" id="objectives-table">
    <thead>
        <tr>
            <th style="color:white">x</th>
            <th>@lang('models/objectives.fields.process_id')</th>
        <th>@lang('models/objectives.fields.perspective_id')</th>
        <th>@lang('models/objectives.fields.descripcion')</th>
        <th>@lang('models/objectives.fields.level')</th>
