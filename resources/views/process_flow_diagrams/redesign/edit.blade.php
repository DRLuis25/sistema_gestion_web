...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <form action="{{route('updateRedesign',[$company_id, $process_map_id, $processFlowDiagram->id])}}" id="updateFlowDiagram-form" method="POST">
                @csrf
                {{ method_field('PATCH') }}
            <div class="card-body">
                <div class="row">
                    @include('process_flow_diagrams.redesign.edit_fields')
                </div>
