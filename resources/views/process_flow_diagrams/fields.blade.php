...
<textarea name="data" id="contentDiagram" cols="30" rows="10" hidden></textarea>
<!-- Data Field -->
...
<script>
  ...
  async function exportDiagram() {
    try {
        var result = await bpmnModeler.saveXML({ format: true },function (err, xml) {
            ...
            $('#createFlowDiagram-form').unbind('submit').submit();
      ...
      console.log($('#createFlowDiagram-form').serialize() + `&data=${obj}`);*/
      //return result.xml;
    } catch (err) {
  ...
  $('#save-button').click(function (e) {
    ...
    $('#createFlowDiagram-form').submit(function(event) {
